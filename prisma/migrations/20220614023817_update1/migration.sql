/*
  ...
  - Made the column `professional_profile_id` on table `User` required. This step will fail if there are existing NULL values in that column.
...
CREATE TABLE "new_User" (
    ...
    CONSTRAINT "User_professional_profile_id_fkey" FOREIGN KEY ("professional_profile_id") REFERENCES "ProfessionalProfile" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
